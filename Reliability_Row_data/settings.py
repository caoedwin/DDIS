...
SAFE_URL = [
    ...
    '/PersonalInfo/Perapi/',
    '/docs/.*',
    '/TestPlanSW/api/token/.*',
    '/TestPlanSW/api/token/refresh/',
    '/TestPlanSW/api/testprojects/.*',
    '/TestPlanSW/api/testplans/.*',
    '/TestPlanSW/api/testprojects_aio/.*',
    '/TestPlanSW/api/testplans_aio/.*',
    '/TestPlanSWOS/api/token/.*',
    '/TestPlanSWOS/api/token/refresh/',
    '/TestPlanSWOS/api/testprojects/.*',
    '/TestPlanSWOS/api/testplans/.*',
    '/TestPlanSWOS/api/testprojects_aio/.*',
    '/TestPlanSWOS/api/testplans_aio/.*',
    # '/redit_Lesson/.*',
    # r'/CDM/CDM-upload/',
    # r'/CDM/CDM-edit/',
    # r'/CDM/CDM-update/.*',
