...
class TestProjectSW(models.Model):
    ...
    Phase_choice = (
        ...
        ('', ''),
        ('A(EVT)', 'A(EVT)'),
        ('EVT Regression1', 'EVT Regression1'),
        ('EVT Regression2', 'EVT Regression2'),
        ('EVT Regression3', 'EVT Regression3'),
        ('EVT Regression4', 'EVT Regression4'),
        ('EVT Regression5', 'EVT Regression5'),
        ('EVT Regression6', 'EVT Regression6'),
        ('B(FVT)', 'B(FVT)'),
        ('FVT Regression1', 'FVT Regression1'),
        ('FVT Regression2', 'FVT Regression2'),
        ('FVT Regression3', 'FVT Regression3'),
        ('FVT Regression4', 'FVT Regression4'),
        ('FVT Regression5', 'FVT Regression5'),
        ('FVT Regression6', 'FVT Regression6'),
        ('FVT Regression7', 'FVT Regression7'),
        ('FVT Regression8', 'FVT Regression8'),
        ('C(SIT)', 'C(SIT)'),
        ('SIT2', 'SIT2'),
        ('SIT Regression1', 'SIT Regression1'),
        ('SIT Regression2', 'SIT Regression2'),
        ('SIT Regression3', 'SIT Regression3'),
        ('SIT Regression4', 'SIT Regression4'),
        ('SIT Regression5', 'SIT Regression5'),
        ('SIT Regression6', 'SIT Regression6'),
        ('SIT Regression7', 'SIT Regression7'),
        ('SIT Regression8', 'SIT Regression8'),
        ('GSKU', 'GSKU'),
        ('Downgrade', 'Downgrade'),
        ('Wave', 'Wave'),
        ('Wave2', 'Wave2'),
...
class TestPlanSW(models.Model):
    ...
    RevisedbasetimeorAttendedtime = models.FloatField('Revised base time (Attended time)', max_length=20, blank=True, null=True)#New
    ...
    DetachableWDockmode = models.CharField('DetachableWDockmode', choices=Choose, max_length=10, default='', blank=True,
                                           null=True)
    PhaseGO = models.CharField('Develop phase(TPL) G/O', choices=Choose, max_length=10, default='', blank=True, null=True)#New
    PhaseEVT = models.CharField('Develop phase(TPL) EVT', choices=Choose, max_length=10, default='', blank=True, null=True)#New
    PhaseFVT = models.CharField('Develop phase(TPL) FVT', choices=Choose, max_length=10, default='', blank=True, null=True)
    PhaseSIT = models.CharField('Develop phase(TPL) SIT', choices=Choose, max_length=10, default='', blank=True, null=True)
    PhaseFFRT = models.CharField('Develop phase(TPL) FFRT', choices=Choose, max_length=10, default='', blank=True, null=True)
    PhaseGsku = models.CharField('Develop phase(TPL) Gsku', choices=Choose, max_length=10, default='', blank=True, null=True)#New
    ...
    ConfigLeverageItem=models.CharField('Config-Leverage Item',choices=ChoiceYN,max_length=5, blank=True, null=True, default='')
    ...
    ConfigSmartItem=models.CharField('Config-Smart Item',choices=ChoiceYN,max_length=5, blank=True, null=True, default='')
