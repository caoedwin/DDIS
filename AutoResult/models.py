...
class AutoItems(models.Model):
    ...
    BaseIncome = models.CharField(max_length=64, null=True, blank=True, verbose_name='Base效益(h)')
    SingleBenefit = models.FloatField(null=True, blank=True, verbose_name='單臺效益(min)')
