    ...
    if request.method == "POST":
        ...
        if request.POST.get("action") == "addSubmit":
            ...
            Add_dic = {
                ...
                "SubscribeDate": request.POST.get("SubscribeDate") if request.POST.get("SubscribeDate") and request.POST.get("SubscribeDate") != 'None' and request.POST.get("SubscribeDate") != 'null' else None,
                ...
                "AcceptanceDate": request.POST.get("AcceptanceDate") if request.POST.get("AcceptanceDate") and request.POST.get("AcceptanceDate") != 'None' and request.POST.get("AcceptanceDate") != 'null' else None,
            ...
            mock_data1.append(
                {
                    ...
                    "SubscribeDate": str(i.SubscribeDate) if i.SubscribeDate else '',
                    "SubscribeForm": i.SubscribeForm,
                    "SubscribeUnitPrice": i.SubscribeUnitPrice,
                    "Number": i.Number,
                    "TotalPrice": float(i.SubscribeUnitPrice) * float(i.Number),
                    "AcceptanceForm": i.AcceptanceForm,
                    "AcceptanceDate": str(i.AcceptanceDate) if i.AcceptanceDate else '',
