    ...
    if request.method == "POST":
        ...
        if request.POST.get("action") == "addSubmit":
            ...
            Add_dic = {
                ...
                "SubscribeDate": request.POST.get("SubscribeDate") if request.POST.get("SubscribeDate") else None,
                ...
                "AcceptanceDate": request.POST.get("AcceptanceDate") if request.POST.get("AcceptanceDate") else None,
