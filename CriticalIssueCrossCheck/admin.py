...
class CriticalIssueAdmin(admin.ModelAdmin):
    ...
    list_display = (
            'id', 'CG', 'Category', 'Object', 'Symptom', 'Reproduce_Steps', 'Root_Cause', 'Solution', 'Action',
    ...
    list_filter = ('id', 'CG', 'Category')  # 过滤器
    search_fields = (
    'id', 'CG', 'Category', 'Object', 'Symptom', 'Reproduce_Steps', 'Root_Cause', 'Solution',)  # 搜索字段
...
class CriticalIssueCrossResultAdmin(admin.ModelAdmin):
    ...
    list_filter = (
        "Projectinfo",
        "Projectinfo__ComPrjCode",
        "CriticalIssue",
        "CriticalIssue__Category",
    )
    # 过滤器
    search_fields = ('Projectinfo__ComPrjCode', 'CriticalIssue__Category', 'result', 'Comment', 'editor', 'edit_time',)  # 搜索字段
    # date_hierarchy = 'Start_time'  # 详细时间分层筛选
